  ...
  - type: FeaturedItemsSection
    ...
    items:
      - type: FeaturedItem
        ...
        text: |
          我幫你盤生意配置一套AI marketing skills —— 內容、SEO、自動化、品牌 —— 再教識你點用 —— 之後唔使長期靠我，慳返你自己捱時間做嘅工夫。

          > **$4,980** 一次性設置費 + **$498/月** AI社群會籍 —— 幫你持續更新、有支援、越做越好 *(隨時可以取消，系統仍然係你嘅)*

          *(廣告/工具平台費用 —— 例如 Meta Ads、你嘅 CRM —— 直接由你自己出，唔包喺入面。頭5位客戶可鎖定呢個價，之後會檢討價錢。)*

          - ✅ AI內容 & 廣告文案 skill —— 用你嘅品牌語氣寫稿，唔係一嚿嚿AI Generic文
          - ✅ AI SEO & AEO skill —— 幫你喺Google *同* ChatGPT呢類AI answer engine度都搵得到
          - ✅ AI 營銷自動化 skill —— 幫你跑campaign同工作流程
          - ✅ AI 品牌 & 社交媒體 skill —— 每個post自動keep住個語調、風格一致
          - ✅ 有更好嘅AI capability出，就幫你升級套skill
      ...
      - type: FeaturedItem
        ...
        text: |
          ...
          - ✅ **包含完整「AI Launch System」—— 做滿頭2個月，設置費全免 —— 仲加埋：**
