...
const components = {
    ...
    JapaneseLearningHub: dynamic(() => import('./sections/JapaneseLearningHub')),
    JapaneseLearningHubZh: dynamic(() => import('./sections/JapaneseLearningHub/indexZh')),
    ...
    TaipoPoppup: dynamic(() => import('./sections/TaipoPoppup')),
