...
export default function TypeJapaneseInputSection() {
    ...
    return (
        <div className="w-full space-y-8">
            <h3 className="text-2xl font-bold mb-6 text-pink-400">Type Japanese Input (ローマ字入力)</h3>

            <div className="max-w-2xl mx-auto space-y-6">
                {/* Input Section */}
                <div className="p-6 bg-slate-800/50 rounded-lg border border-purple-500/30">
                    <h4 className="text-lg font-bold text-indigo-300 mb-4">Romanized Input</h4>
                    
                    <div className="space-y-4">
                        <textarea
                            value={romanInput}
                            onChange={(e) => setRomanInput(e.target.value)}
                            placeholder="Type romanized Japanese (e.g., 'konnichiha')"
                ...
                {romanInput && (
                    <div className="p-6 bg-slate-800/50 rounded-lg border border-green-500/30">
                        <h4 className="text-lg font-bold text-green-400 mb-4">Converted Result</h4>
                ...
                <div className="p-4 bg-indigo-900/20 rounded-lg border border-indigo-500/30">
                    <p className="text-sm text-indigo-300">
                        <span className="font-semibold">💡 Tip:</span> Type Romanized Japanese and instantly see it converted to Hiragana or Katakana. This helps you practice recognizing Japanese character patterns.
                    </p>
                </div>
            </div>
        </div>
